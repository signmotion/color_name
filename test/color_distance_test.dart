...
void main() {
  group('ColorDistance', () {
    test('RgbColorSqrtDistance', () {
      ...
      final a = 0x000000.rgbInt8ToRgbInt8Color;
      final b = 0xffffff.rgbInt8ToRgbInt8Color;
      expect(cd.distance(a, b).roundToDecimals(2), 441.67);

      {
        final c = 0x010203.rgbInt8ToRgbInt8Color;
        expect(cd.distance(a, c).roundToDecimals(2), 3.74);
      }

      {
        final c = 0xf1f2f3.rgbInt8ToRgbInt8Color;

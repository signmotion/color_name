...
This is a general style guide that shall govern over all `UniColorName` repositories. The aim is
...
- You must always use relative imports for imports within the `UniColorName` library
